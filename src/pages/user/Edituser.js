...
const Edituser = () => {
    ...
    const Edituser = (e) => {
        ...
        setisLoading(true)
        axios.patch(`${app_url}/api/user/${slug}`, { name: Name, status: Status, email: Email, role_id: '3', phone: Phone, image: userimg?.toString(), address: Address, membership_id: MembershipId }, {
            headers: {
                'Authorization': `Bearer ${token}`,
